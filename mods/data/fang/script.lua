...
local ratingGrab = {'b3/ratings/sick', 'b3/ratings/good', 'b3/ratings/bad', 'b3/ratings/shit'} -- what it'll grab | either change these or the names down below | IF CHANGED, FILE NAME HAS TO BE IN MODS/IMAGES
local ratingGrabOp = {'b3/ratings/sick', 'b3/ratings/good', 'b3/ratings/bad', 'b3/ratings/shit'}
local numPrefix = 'b3/ratings/num'               -- Easier to change numbers | Name it like "rednum" or "Invnum"
local numPrefixOp = 'b3/ratings/num'
